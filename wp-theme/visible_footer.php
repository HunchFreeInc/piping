    ...
    <div class="grid-container">
        ...
        <div class="grid-x grid-margin-x grid-padding-y align-center align-top">
            ...
            <div class="large-4 medium-4 small-12 cell medium-text-left text-center">
                ...
                <img src="/wp-content/uploads/2018/01/footer-logo-1.png" alt="Piping and Equipment Logo"/>
                <p class="small-p">Piping and Equipment (P&E) is your full line industrial distributor of pipe, valves, fittings and related products specializing in servicing the mid-stream and down-stream markets as well the contractors and fabricators that support them.</p>
            ...
            <div class="large-4 medium-4 small-12 cell medium-text-left text-center top-border-white">
              ...
              <div class="cell">
                ...
                <a href="/markets/" class="menu-link foot-link">Markets</a>
              ...
              <div class="cell">
                ...
                <a href="/products/" class="menu-link foot-link">Products</a>

              </div>

              <div class="cell">

                <a href="/our-story/" class="menu-link foot-link">Our Story</a>

              </div>

              <div class="cell">

                <a href="/careers/" class="menu-link foot-link">Careers</a>

              </div>

              <div class="cell">

                <a href="/contact-us/" class="menu-link foot-link">Contact Us</a>
            ...
            <div class="large-4 medium-4 small-12 cell medium-text-left text-center top-border-white">
                ...
                <p>7614 Bluff Point Drive<br>
                   Houston, TX 77086<br>

                <i class="fas fa-phone-square"></i> <a href="tel:8003331435">800.333.1435</a></p>

                <a href="https://www.facebook.com/pages/Piping-Equipment/163035277049186?ref=br_rs" target="_blank"><i class="fab fa-facebook fa-2x"></i></a>&nbsp; &nbsp;<a href="https://www.linkedin.com/company/15271978/" target="_blank"><i class="fab fa-linkedin fa-2x"></i></a>	
    ...
    <div class="grid-container">
        ...
        <div class="grid-x grid-margin-x grid-margin-y align-middle">
            ...
            <div class="cell large-6 text-center medium-text-left">
                ...
                <p>© {$year} Piping and Equipment. All Rights Reserved.</p>

            </div>

            <div class="cell large-6 text-center medium-text-right">

                <a href="https://hunchfree.com" target="_blank"><img src="/wp-content/uploads/2018/01/hf-logo.png" alt="Hunch Free Digital Marketing Logo"/></a>
